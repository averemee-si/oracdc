...
#
ARG    SQUP_WIRE_VERSION=4.9.8
ARG    SQUP_OKIO_VERSION=3.9.0
ARG    SQUP_JAVAPOET_VERSION=1.13.0
ARG    SQUP_KOTLINPOET_VERSION=1.16.0
ARG    PROTOBUF_VERSION=3.25.3
ARG    PROTO_COMMON_VERSION=2.37.1
...
RUN    set -eux && apt-get update && apt-get --yes install netcat-traditional tzdata bash wget 
...
ENV    KAFKA_OPTS="-Dchronicle.analytics.disable=true -Dchronicle.disk.monitor.disable=true -Dchronicle.queue.warnSlowAppenderMs=500 --add-exports java.base/jdk.internal.ref=ALL-UNNAMED --add-exports java.base/sun.nio.ch=ALL-UNNAMED --add-exports jdk.unsupported/sun.misc=ALL-UNNAMED --add-exports jdk.compiler/com.sun.tools.javac.file=ALL-UNNAMED --add-opens jdk.compiler/com.sun.tools.javac=ALL-UNNAMED --add-opens java.base/java.lang=ALL-UNNAMED --add-opens java.base/java.lang.reflect=ALL-UNNAMED --add-opens java.base/java.io=ALL-UNNAMED --add-opens java.base/java.util=ALL-UNNAMED"
