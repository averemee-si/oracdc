image:https://img.shields.io/badge/License-AGPL_v3%2B-blue[License,link=https://raw.githubusercontent.com/averemee-si/oracdc/refs/heads/master/LICENSE]
...
4. https://mvnrepository.com/artifact/solutions.a2.oracle/oracdc-kafka[Maven Central]
...
Minimum supported and recommended version is https://openjdk.org/projects/jdk/25/[Java 25]. To run using this version, you need to pass the following arguments to the JVM
...
== Authors
**Aleksei Veremeev** - *Initial work* - http://a2.solutions/[A2 Rešitve d.o.o./A2 Solutions LLC]

== License

This project is licensed under a commercial and under the AGPL license.
...
1. Confluent Hub and Dockerfile security fixes 
...
1. `a2.archive.log.dest.id` parameter

2. Transition to JDK25
...
1. The license has been changed to dual licensing: commercial and AGPL v3.0+
