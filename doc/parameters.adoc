...
`a2.topic.mapper` - The fully qualified name of the class that defines the Kafka topic to which data from the tables should be sent. The class must implement the solutions.a2.cdc.oracle.runtime.config.KafkaTopicNameMapper interface. The connector comes with two predefined classes:
