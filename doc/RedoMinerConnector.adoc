...
|BFILE |Redo files will be read from the remote file system as Oracle database BFILEs using the Oracle Net protocol.

|TRANSFER | Redo logs will be read from the Oracle ASM using https://docs.oracle.com/en/database/oracle/oracle-database/26/arpls/DBMS_FILE_TRANSFER.html[DBMS_FILE_TRANSFER] package. This feature will be available in the first quarter of CY2026. If you need this functionality urgently, please contact us at oracle@a2.solutions.
...
create or replace directory CDC_ONLINE as '/oradata/archive';
----
