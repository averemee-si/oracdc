...
|a2.topic.mapper | String | The fully qualified name of the class that defines the Kafka topic to which data from the tables should be sent. The class must implement the https://github.com/averemee-si/oracdc/blob/feature/advanced-compression/src/main/java/solutions/a2/cdc/oracle/TopicNameMapper.java[solutions.a2.cdc.oracle.TopicNameMapper] interface.
