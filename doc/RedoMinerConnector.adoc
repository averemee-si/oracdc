...
The connector comes with two predefined classes: `solutions.a2.cdc.oracle.runtime.config.KafkaDefaultTopicNameMapper` and `solutions.a2.cdc.oracle.OraCdcSingleTopicNameMapper`.
...
== a2.topic.mapper=solutions.a2.cdc.oracle.OraCdcSingleTopicNameMapper
