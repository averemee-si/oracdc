...
|a2.ssh.provider | sshj or maverick | Optional, library that provides SSH connection: `maverick` for https://jadaptive.com/[Maverick Synergy] or `sshj` for https://github.com/hierynomus/sshj[Hierynomus sshj] or `mina` for https://mina.apache.org/sshd-project/[Apache Mina SSHD]. Default - `sshj`
